...
export default function CheckinClient({ tripId, facilityName }: { tripId: string; facilityName: string }) {
      ...
      <div className="p-8 max-w-2xl mx-auto space-y-4">
        <div className="bg-green-100 text-green-800 p-6 rounded-lg shadow border border-green-200">
          ...
          {success.photo && (
            ...
            <img src={success.photo} alt="Check-in proof" className="mt-4 w-full max-w-sm rounded shadow-sm border border-gray-200" />
          )}
          <button 
            onClick={() => router.push('/')}
  ...
  return (
    <div className="p-8 max-w-2xl mx-auto space-y-6">
      <h1 className="text-2xl font-bold text-gray-900">Record Check-in: {facilityName}</h1>
      ...
      <div className="bg-white p-6 rounded-lg shadow space-y-4 border border-gray-200">
        ...
        >
          {loading ? 'Recording Check-in...' : 'Submit Check-in'}
        </button>
